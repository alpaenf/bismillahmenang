...
export async function POST(request: Request) {
  try {
    ...
    if (hasApk) {
      ...
      recommendations = [
        ...
        },
        {
          id: 'rec_rew_2',
          priority: 'should_do',
          actionText: 'Periksa Situs Resmi Perusahaan',
          explanation: 'Cek pengumuman resmi pemenang di situs web utama tanpa mengklik link dari SMS.'
        }
      ];
    } else if (hasLink) {
      riskLevel = 'medium';
    ...
    // SIMPAN HASIL ANALISIS KE SUPABASE
    ...
    const responsePayload: SingleAnalysisResponse = {
      ...
      indicators,
      recommendations,
      disclaimer: 'Analisis dihasilkan secara otomatis oleh sistem deteksi AntiScam dan tersimpan di database. Tetap waspada terhadap pesan mencurigakan.',
    };
